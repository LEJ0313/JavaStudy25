...
public class MainExam {
	...
	static void scores(byte[] engScores, byte[] korScores, String[] name) {
		//성적관리용 부 메뉴
		...
		while(run) {
			...
			System.out.println("1. 영어 성적 | 2. 국어 성적 | 3. 메인 메뉴");
			System.out.println("===================================");
			System.out.print(">>>");
	...
	static void scores2(byte[] korScores, String[] name) {
	...
	static void scores(byte[] engScores, String[] name) {
		...
		while(run) {
			...
			for(int i = 0; i < engScores.length; i++) {
				...
				//풀어야함System.out.println(name[i] + "학생은 " + engScore[i] + "점 이고, 등수는 " + rank + "위 입니다.");
			...
			case 3 :
				...
				System.out.println("수정할 " + name[nameNum - 1] + "의 영어 성적은 " + 
				engScores[nameNum - 1]);
	...
	static void totalScores(int[] totalScores, byte[] engScores, byte[] korScores, 
			String[] name) {
		Scanner studentSC = new Scanner(System.in);
	...
	static void totalScores2(int[] totalScores, byte[] engScores, byte[] korScores, String[] name) {
		
		System.out.println("==========전체성적을 처리합니다.==========");
		System.out.println("개개인의 국어성적과 영어성적을 합계합니다.");
		
		for(int i = 0 ; i < totalScores.length; i++) {
			
			totalScores[i] = engScores[i] + korScores[i];
			
			System.out.println(name[i] + "학생의 총 점 : " + totalScores[i] + "|평균 : " + 
			totalScores[i]/2);
	...
	static void searchScores2(int[] totalScores, byte[] engScores, byte[] korScores, String[] name) {
