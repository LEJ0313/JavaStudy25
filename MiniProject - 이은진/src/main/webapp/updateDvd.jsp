  ...
  <%
	...
	%>		
	 <div class="row align-items-md-stretch">	  	
		...
		<div class="col-md-7">	
		<form name="newDvd" action="./processUpdateDvd.jsp" method="post" enctype ="multipart/form-data">
		
			
			<div class="mb-3 row">
				<label class="col-sm-2">DVD코드</label>
				<div class="col-sm-5">
					<input type="text" name="dvdId" id="dvdId" class="form-control" value='<%=rs.getString("dvd_id")%>'>
				</div>
			</div>
			<div class="mb-3 row">
				<label class="col-sm-2">DVD명</label>
				<div class="col-sm-5">
			...
			<div class="mb-3 row">
				<label class="col-sm-2">원작자</label>
				<div class="col-sm-5">
			...
			<div class="mb-3 row">
				<label class="col-sm-2">제작일</label>
				<div class="col-sm-5">
			...
			<div class="mb-3 row">
				...
				<div class="col-sm-8">
					<input type="radio" name="condition" value="New " >신규DVD
					<input type="radio" name="condition" value="Old" > 중고DVD 
